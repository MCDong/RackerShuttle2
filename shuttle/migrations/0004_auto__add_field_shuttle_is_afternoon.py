...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Shuttle.is_afternoon'
        db.add_column(u'shuttle_shuttle', 'is_afternoon',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Shuttle.is_afternoon'
        db.delete_column(u'shuttle_shuttle', 'is_afternoon')
    ...
    models = {
        ...
        u'shuttle.shuttle': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_afternoon': ('django.db.models.fields.BooleanField', [], {}),
